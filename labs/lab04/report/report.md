...
2. В межсетевой экран добавлено правило, разрешающее HTTP:
   ...
   ![Разрешение сервиса http в firewalld](1.png){ #fig:004 width=80% }
...
4. На клиенте в браузере открыт адрес `http://192.168.1.1`.  
   ...
   ![HTTP Server Test Page](2.png){ #fig:007 width=80% }

5. В access_log отразились запросы клиента:

   ![Записи access_log после обращения клиента](3.png){ #fig:008 width=80% }
...
![Прямая зона](4.png){ #fig:009 width=80% }
...
![Обратная зона](5.png){ #fig:010 width=80% }
...
![Конфигурация server.akabrikosov.net](6.png){ #fig:011 width=80% }
...
![Конфигурация www.akabrikosov.net](7.png){ #fig:012 width=80% }
...
![Создание каталога и index.html](8.png){ #fig:013 width=80% }
...
![Доступ к server.akabrikosov.net](9.png){ #fig:015 width=80% }

### www.akabrikosov.net

![Доступ к www.akabrikosov.net](10.png){ #fig:016 width=80% }
...
![Содержимое http.sh](11.png){ #fig:017 width=80% }
