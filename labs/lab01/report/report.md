...
2. В рабочем каталоге проекта созданы необходимые файлы для автоматического развертывания — 01-user.sh, 01-hostname.sh и Vagrantfile.
   ...
   ![Скрипт 01-user.sh](1.png){ #fig:001 width=80% }

   ![Скрипт 01-hostname.sh](2.png){ #fig:002 width=80% }

   ![Фрагмент Vagrantfile с описанием provision](3.png){ #fig:003 width=80% }
...
7. Подключение к серверу через консоль выполнено командой:
   ...
   ![Подключение к серверу через SSH](8.png){ #fig:008 width=80% }
