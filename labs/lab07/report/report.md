...
![Просмотр оригинального файла ssh-custom.xml](1.png){ #fig:001 width=80% }
...
![Редактирование службы ssh-custom.xml](2.png){ #fig:002 width=80% }
...
![Добавление службы и проверка](3.png){ #fig:003 width=80% }
...
![Проверка нового порта SSH](4.png){ #fig:004 width=80% }

![Проверка нового порта SSH](5.png){ #fig:005 width=80% }
...
![Проверка sysctl параметра ip_forward](6.png){ #fig:006 width=80% }
...
![Скрипт firewall.sh](9.png){ #fig:009 width=80% }
