...
![Настройка списка протоколов в dovecot.conf](image/1.png){ #fig:001 width=80% }

## Проверка механизма аутентификации

![Проверка механизма аутентификации в 10-auth.conf](image/2.png){ #fig:002 width=80% }

## Источники пользователей и паролей (PAM + passwd)

![Настройка источников аутентификации в auth-system.conf.ext](image/3.png){ #fig:003 width=80% }

## Расположение почтовых ящиков (Maildir)

![Настройка расположения почтовых ящиков в 10-mail.conf](image/4.png){ #fig:004 width=80% }

## Межсетевой экран и запуск служб

![Настройка межсетевого экрана для почтовых сервисов](image/5.png){ #fig:005 width=80% }

## Мониторинг работы почтовых служб

![Записи в журнале Postfix и Dovecot](image/6.png){ #fig:006 width=80% }

## Проверка почтового ящика на сервере

![Просмотр почтового ящика пользователя на сервере](image/7.png){ #fig:007 width=80% }

## Evolution: идентификация пользователя

![Настройка учетной записи в Evolution — идентификация](image/8.png){ #fig:008 width=80% }

## Evolution: входящая почта (IMAP)

![Настройка входящей почты IMAP в Evolution](image/9.png){ #fig:009 width=80% }

## Evolution: исходящая почта (SMTP)

Проверены параметры SMTP: сервер mail.user.net, порт 25, без шифрования и без аутентификации.

![Настройка исходящей почты SMTP в Evolution](image/10.png){ #fig:010 width=80% }

## Отправка и получение тестовых писем

![Получение тестового письма в Evolution](image/11.png){ #fig:011 width=80% }

## Проверка POP3 через Telnet

![Проверка POP3 через Telnet](image/12.png){ #fig:012 width=80% }
