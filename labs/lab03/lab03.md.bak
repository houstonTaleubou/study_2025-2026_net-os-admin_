...
![Открытие файла /etc/systemd/system/dhcpd.service и замена строки.](image/5.png){#fig-5 width=70%}

Перезагрузим конфигурацию dhcpd и разрешим загрузку DHCP-сервера при запуске виртуальной машины server (рис. @fig-6):

![Перезагрузка конфигурации dhcpd и разрешение автозагрузки.](image/6.png){#fig-6 width=70%}
...
![Добавление записей в DNS-зоны и проверка доступности.](image/7.png){#fig-7 width=70%}
...
![Настройка межсетевого экрана и восстановление контекста SELinux.](image/8.png){#fig-8 width=70%}
